        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                ...
                <div class="relative ms-4">
                    <img class="w-full rounded-md" src="{{ asset("assets/images/hero.webp") }}" alt="Image Description">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                ...
                <div wire:key="{{$brand->id}}" class="bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <a href="/products?selected_brands[0]={{$brand->id}}" class="">
                        <img src="{{url("storage",$brand->images)}}" alt="" class="object-cover w-full h-64 rounded-t-lg">
                    </a>
    ...
    <div class="bg-orange-200 py-20">
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                ...
                <a wire:key="{{$category->id}}" class="group flex flex-col bg-white border shadow-sm rounded-xl
                 hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                   href="/products?selected_categories[0]={{$category->id}}">
                    <div class="p-4 md:p-5">
                        <div class="flex justify-between items-center">
                            <div class="flex items-center">
                                <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{url("storage",$category->images)}}" alt="Image Description">
                                <div class="ms-3">
